...
public class EnemyMageSuspiciousState : EnemyMageState
{
    ...
    public EnemyMageSuspiciousState(BaseMageEnemy _enemy, EnemyMageStateMachine _stateMachine, Animator _animController, string _animName)
